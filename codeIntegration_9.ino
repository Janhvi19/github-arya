...
int period=1000, flag,s , sats, Actualtime,UTCtime,UTCtime1,UTCtime2,a,time_HS=0,packetCount,packetFlag,EPC,temporary;
...
sprintf(buffers,"1033, %d:%d:%d,%d, %f, %lf, %f, %lf, %02d:%02d:%02d, %lf, %lf, %lf, %d, %f,%f ,%d",
                 UTCtime1, UTCtime2, s,EPC, realAltitude,temperature, volts, pressure,hr, mins, sec, 
                 gAltitude, latitude_val, longitude_val, sats, tiltx, tilty,EPC); 
